...
status_foot()
{
  ...
  while (1)
  {
    ...
    sprintf(feeter, "\033[1;34;46m %02d:%02d:%02d %s \033[30;47m 人"
      "\033[31m%4d\033[30m 我是 \033[31m%-12s\033[30m 銀\033[34m%5dK"
...
status_foot()
{
  ...
  sprintf(feeter, COLOR1 " %8.8s %02d:%02d " COLOR2 " %s \033[1;30;44m線上\033[m\033[1;44m %-3d\033[m\033[1;30;44m人\033[m\033[1;30;44m，我是\033[m\033[1;44m %-12s\033[m\033[1;30;44m [水球]\033[m\033[1;32;44m%-5s\033[m",
    fshm->today, ufo / 60, ufo % 60,"　　　　　　　　", total_user, cuser.userid, flagmsg); 
...
#ifdef SP_SEND_MONEY
  "bin/xyz.so:year_bonus", PERM_SYSOP, - M_XMODE,
  "Year Bonus  $ 站長灑錢 $ ",
#endif

/* floatJ: 建立站誤測試用的項目 */
  "bin/test.so:test", PERM_ALLADMIN, - M_XMODE,
  "ADMIN TEST  > 站誤測試 < ",
